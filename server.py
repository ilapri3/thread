...
def main():
     ...
     try:
         while True:
             command = input(
                 "Введите команду (shutdown, pause, resume, show logs, clear logs, clear id): ").strip().lower()
             ...
             if command == 'shutdown':
                 ...
                 print(
                     "Неизвестная команда. Доступные команды: shutdown, pause, resume, show logs, clear logs, clear id.")
